 ...
 */
public class SendZeWatchData extends IntentService implements
    ...
    public static final String UPDATE_WATCHFACE = "ACTION_UPDATE_WATCHFACE";
    private static final String WATCH_SERVICE = "WatchService";

    private GoogleApiClient mGoogleApiClient;

    public SendZeWatchData() {
        super(WATCH_SERVICE);
    }
    ...
    protected void onHandleIntent(Intent intent) {
        if (intent != null
            ...
            mGoogleApiClient = new GoogleApiClient.Builder(SendZeWatchData.this)
